namespace Demo.examples
{
    ...
    class webgl_rtt : Example
    {
        ...
        public override void Load(Control control)
        {
            ...
            rtTexture = new WebGLRenderTarget(control.Width, control.Height) { MinFilter = ThreeCs.Three.LinearFilter, MagFilter = ThreeCs.Three.NearestFilter, Format = ThreeCs.Three.RGBFormat };
